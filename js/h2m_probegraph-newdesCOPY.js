    ...
    */
    ...
    container.innerHTML = '\
        <div id="graph_upper_bar" style="width: '+width+'px; height: 35px; background-color: white; text-align: center; color: #FFF; font-size: '+probe_data_font_size+'px; font-family: Helvetica, sans-serif; padding-top: '+Math.floor((height * 0.15) * 0.1)+'px;">\
            ...
            <div id="probe_minigraph" style="width:200px; height:12px; background-color:white; margin-top:5px; float:left; margin-left:100px; border:1px solid #e6e5e5;">\
            ...
            <div class="question_label" id="probe_question_label_'+probe_id+'" style="font-family:Lato; font-size:6px; color:#777; float:right; margin-right:10px;">Question 1 of 2: Body Temperature</div>\
        ...
        <div id="graph_main_content" style="width: '+width+'px; height: '+canvas_height+'px"></div>\
    ...
    for (var n = 0 ;  n < max_days ; n++){
        ...
        if (data_present != 0){
            ...
            var tooltip_box_value = new Konva.Text({
                    ...
                    text: sample_data[matching_item].value,
                    fontSize: 8,
                    fontStyle: 'bold',
                    fontFamily: 'Arial',
                    opacity: 1,    
